...
def managed_files(machine: dict) -> list[ManagedFile]:
    ...
    if os_name in {"arch"}:
        ...
        add_file(entries, "linux/arch/.config/waybar/config", "~/.config/waybar/config", "waybar")
        add_file(entries, "linux/arch/.config/waybar/style.css", "~/.config/waybar/style.css", "waybar")
        add_file(entries, "linux/arch/.config/waybar/waybar.sh", "~/.config/waybar/waybar.sh", "waybar")
        add_glob(entries, "linux/arch/.config/waybar/modules/*", "~/.config/waybar/modules", "waybar")
        add_file(entries, "linux/arch/.config/gtk-3.0/gtk.css", "~/.config/gtk-3.0/gtk.css", "gtk")
        add_file(entries, "linux/arch/.config/gtk-3.0/settings.ini", "~/.config/gtk-3.0/settings.ini", "gtk")
        add_file(entries, "linux/arch/.config/gtk-4.0/gtk.css", "~/.config/gtk-4.0/gtk.css", "gtk")
        add_file(entries, "linux/arch/.config/gtk-4.0/settings.ini", "~/.config/gtk-4.0/settings.ini", "gtk")
