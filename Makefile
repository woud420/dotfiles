.PHONY: all help install install-minimal install-no-packages backup-bash brew-sync clean-backup legacy dotfiles-doctor dotfiles-dry-run dotfiles-install dotfiles-diff-live dotfiles-backup
.ONESHELL:
